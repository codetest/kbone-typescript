<template>
  <div>
    ...
    <img src="https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=10955058,2823889533&fm=11&gp=0.jpg" />
  </div>
</template>
...
<script lang="ts">
  ...
  export default class App extends Vue{
    ...
    onShareAppMessage(options: WechatMiniprogram.Page.IShareAppMessageOption): WechatMiniprogram.Page.ICustomShareContent{
        return {
          title: "页面内分享测试",
          path: "/other?q=2352353646"
        }
    }

    testClick(){
      this.test = "Hello Other at " + new Date().toString()
    }
